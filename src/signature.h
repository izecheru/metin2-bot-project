...
namespace elaris {
		...
		inline OffsetSig CPyhtonMiniMap("\x8B\x0D\x00\x00\x00\x00\x8B\x3D\x00\x00\x00\x00\x75", "xx????xx????x", 0x2);
		inline OffsetSig CPyhtonBackground("\x8B\x3D\x00\x00\x00\x00\x75", "xx????x", 0x2);
